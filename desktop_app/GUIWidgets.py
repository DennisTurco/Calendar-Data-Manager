...
def create_graph_types_scroll_frame(master, square_check_image: PhotoImage, square_image: PhotoImage):
    ...
    total_hours_per_year = ctk.CTkCheckBox(graph_types_frame, text=GraphType.HOURS_PER_YEAR.value, onvalue="on", offvalue="off")
    total_hours_per_year.grid(row=1, column=0, padx=10, pady=10, sticky="ew")
    total_hours_per_year.select()
    total_hours_per_month = ctk.CTkCheckBox(graph_types_frame, text=GraphType.HOURS_PER_MONTH.value, onvalue="on", offvalue="off")
    total_hours_per_month.grid(row=1, column=1, padx=10, pady=10, sticky="ew")
    total_hours_per_month.select()
    total_hours_by_summary = ctk.CTkCheckBox(graph_types_frame, text=GraphType.HOURS_BY_SUMMARY_BAR.value, onvalue="on", offvalue="off")
    total_hours_by_summary.grid(row=2, column=0, padx=10, pady=10, sticky="ew")
    total_hours_by_summary.select()
    total_hours_by_summary2 = ctk.CTkCheckBox(graph_types_frame, text=GraphType.HOURS_BY_SUMMARY_PIE.value, onvalue="on", offvalue="off")
    total_hours_by_summary2.grid(row=2, column=1, padx=10, pady=10, sticky="ew")
    total_hours_by_summary2.select()
    total_hours_per_year_by_summary = ctk.CTkCheckBox(graph_types_frame, text=GraphType.HOURS_PER_YEAR_BY_SUMMARY.value, onvalue="on", offvalue="off")
    total_hours_per_year_by_summary.grid(row=3, column=0, padx=10, pady=10, sticky="ew")
    total_hours_per_month_by_summary = ctk.CTkCheckBox(graph_types_frame, text=GraphType.HOURS_PER_MONTH_BY_SUMMARY.value, onvalue="on", offvalue="off")
    total_hours_per_month_by_summary.grid(row=3, column=1, padx=10, pady=10, sticky="ew")
    total_hours_per_month_grouped_by_year = ctk.CTkCheckBox(graph_types_frame, text=GraphType.HOURS_PER_MONTH_GROUPED_BY_YEAR.value, onvalue="on", offvalue="off")
